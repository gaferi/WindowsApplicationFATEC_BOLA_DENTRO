...
Public Class classe_consulta_ajudante_quadra
    ...
    Public Function detalhe() As DataSet
        ...
        var.Append(" SELECT a.alunoID, nome_aluno, rg_aluno FROM boladentro.tb_ajudante_quadra ")
        var.Append(" INNER JOIN tb_aluno as a ")
        var.Append(" ON tb_ajudante_quadra.alunoID = a.alunoID; ")
