...
Public Class classe_consulta_arbitros
    ...
    Public Function detalhe() As DataSet
        ...
        var.Append(" SELECT a.alunoID, nome_aluno, rg_aluno FROM boladentro.tb_arbitros ")
        var.Append(" INNER JOIN tb_aluno as a ")
        var.Append(" ON tb_arbitros.alunoID = a.alunoID; ")
