...
Public Class classe_consulta_boleiro
    ...
    Public Function detalhe() As DataSet
        ...
        var.Append(" SELECT a.alunoID, nome_aluno, rg_aluno FROM boladentro.tb_boleiro ")
        var.Append(" INNER JOIN tb_aluno as a ")
        var.Append(" ON tb_boleiro.alunoID = a.alunoID; ")
